    ...
    <div class="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">ESTA ES LA PLANTILLA PERROS WOF WOF</h2>
            <p class="mt-8 text-pretty text-lg font-medium text-gray-300 sm:text-xl/8">Encargados de proporcionar a los interesados calidad de la buena y no me refiero a la heroina xD.</p>
          </div>
          <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
            <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-base/7 font-semibold text-white sm:grid-cols-2 md:flex lg:gap-x-10">
              <a href="#">HOLA XD <span aria-hidden="true">&rarr;</span></a>
              <a href="#">EGRESADO INGE<span aria-hidden="true">&rarr;</span></a>
              <a href="#">CALIFICACION GOOD <span aria-hidden="true">&rarr;</span></a>
              <a href="H">MEMORIA AL 100 <span aria-hidden="true">&rarr;</span></a>
            </div>
...
<table border="1">
    ...
    <td>
    Bienvenido a la pagina de perros
</td>
</tr>
